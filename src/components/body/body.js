import "../../index.css";
import "./body.css";
import FeatureImg from "../img/optimize.gif";
    ...
    <div className="body">
      <div className="background-image grid place-items-center my-6">
        <div className="">
          ...
          A farmer is a magician,who produce money from the mud
          </p>
          <p className="text-6xl  font-bold text-center uppercase mb-4 text-green-600 ">
          Sakha
          </p>
          <p className="text-2xl font-bold text-center text-white">
            We Are Farmers Friend
          </p>
        </div>
      </div>
      <CardBar />
